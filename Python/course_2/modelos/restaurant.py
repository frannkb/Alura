...
class Restaurant:
	...
	def list_restaurants(cls):
		print(f'{'Restaurant Name'.ljust(25)} | {'Category Name'.ljust(25)} | {'Active?'.ljust(25)} | {'Avaliation'}')
	...
	def avaliation_average(self):
		...
		sum_grades = sum(avaliation._grades for avaliation in self._avaliation)
